...
public class CreateStoryActivity extends StoryActivityBase {
	...
	private void launchSoundIntent() {
		...
		Intent soundRecordIntent = new Intent(CreateStoryActivity.this, SoundRecordActivity.class );
		...
		soundRecordIntent.putExtra(SoundRecordActivity.EXTRA_OUTPUT, soundFile.getAbsolutePath());
	...
	private void launchCameraIntent() {
		...
		Intent mediaStoreIntent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
		...
		mediaStoreIntent.putExtra(MediaStore.EXTRA_OUTPUT, fragment.imagePath);
		
		// TODO - Start a new activity for result, using the new intent and the request
		// code CAMERA_PIC_REQUEST
		
		startActivityForResult(mediaStoreIntent, CAMERA_PIC_REQUEST);
	...
	private void launchVideoCameraIntent() {
		...
		videoCameraIntent.putExtra(MediaStore.EXTRA_OUTPUT, videoFileUri);
		...
		startActivityForResult(videoCameraIntent, CAMERA_VIDEO_REQUEST);
